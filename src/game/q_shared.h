...
//
//Feen: I documented the actual command associated with the buttons that are of use to us.
//		BUTTON_ cmds are cmd.buttons
//		WBUTTON_ cmds are cmd.wbuttons
//		All tested... All work...
#define BUTTON_ATTACK       1           // +attack
#define BUTTON_TALK         2           // displays talk balloon and disables actions
#define BUTTON_USE_HOLDABLE 4           // +useitem //Feen: this cmd and +salute are not currently used for anything...
#define BUTTON_GESTURE      8           // +salute  //Feen: normally used for bot taunts, nothing now....
...
#define WBUTTON_PRONE       128 // Arnout: wbutton now //Feen: How does this indicate prone? It's basically just a heartbeat....
//----(SA) end
